        ...
        <div className='py-28 md:pb-36 md:pt-32  px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 first:border-t text-base py-6'>
                        {/* Hotel Details */}
                        <div className=' flex flex-col md:flex-row'>
                            <img src={booking.room.images[0]} alt="room-image" className='md:w-44 rounded shadow object-cover' />
