    ...
    return (
        ...
        >
            <form
                ...
                className="flex bg-white rounded-xl max-w-4xl max-md:mx-2 relative"
            >
                <img src={assets.regImage} alt="registration-icon" className="w-1/2 rounded-xl hidden md:block" />
                <div className="flex flex-col md:w-1/2 p-8 md:p-10 relative">
                    ...
                    <div className="w-full mt-4">
                        ...
                        <input onChange={(e) => setContact(e.target.value)} value={contact} id="contact" type="number" placeholder="Type here" className="border border-gray-200 rounded w-full px-3 py-2.5 mt-1 outline-indigo-500 font-light" required />
                    </div>
                    {/* Address */}
                    <div className="w-full mt-4">
